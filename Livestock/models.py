...
class Paddock (models.Model):
    ...
    no_livestock = models.CharField(blank=True, max_length=100)
    livestock_categories = models.CharField (blank=True, max_length=100)
...
class Livestock(models.Model):
    ...
    SlaughterDate = models.CharField(max_length=18, null=True)
...
class TimeLine(models.Model):
    ...
    Paddock= models.CharField(max_length=2)
