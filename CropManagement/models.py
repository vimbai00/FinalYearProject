...
class Farm (models.Model):
    ...
    def get_absolute_url(self):
        return reverse("CropManagement:Farm_single", kwargs={"pk": self.pk})
...
class Staff (models.Model):
    ...
    country = models.CharField(max_length=20, default='Zimbabwe')
    ...
    def get_absolute_url(self):
        return reverse("CropMangement:staff_single", kwargs={"pk": self.pk})
