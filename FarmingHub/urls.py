...
urlpatterns = [
    ...
    path('SupplyChainManagement/', include('SupplyChainManagement.urls')),


    #MarketPlace
     path('home_view',views.home_view,name='markethome'),
    ...
    path('FishFarmingApp/', include('FishFarmingApp.urls')),
